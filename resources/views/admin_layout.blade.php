        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-category-product')}}">Thêm danh mục games</a></li>
						<li><a href="{{URL::to('/all-category-product')}}">Liệt kê danh mục games</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-product')}}">Thêm games</a></li>
						<li><a href="{{URL::to('/all-product')}}">Liệt kê games</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2026 Admin. All rights reserved | GameStore</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
